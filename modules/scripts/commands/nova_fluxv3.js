...
module.exports.config = {
  ...
  description: "Generate an AI image (flux-realism)",
  adminOnly: false,
  usePrefix: true,
  cooldown: 5,
};
...
module.exports.run = async function ({ event, args }) {
  ...
  try {
    const response = await axios.get(`https://api.kenliejugarap.com/flux-realism/?prompt=${encodeURIComponent(prompt)}`);
