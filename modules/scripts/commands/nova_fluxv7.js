...
module.exports.config = {
  ...
  description: "Generate an AI image (flux-3d)",
  adminOnly: false,
  usePrefix: true,
  cooldown: 5,
};
...
module.exports.run = async function ({ event, args }) {
  ...
  try {
    const response = await axios.get(`https://api.kenliejugarap.com/flux-3d/?prompt=${encodeURIComponent(prompt)}`);
