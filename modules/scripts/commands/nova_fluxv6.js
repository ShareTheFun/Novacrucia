...
module.exports.config = {
  ...
  description: "Generate an AI image (flux-anime-v2)",
  adminOnly: false,
  usePrefix: true,
  cooldown: 5,
};
...
module.exports.run = async function ({ event, args }) {
  ...
  try {
    const response = await axios.get(`https://api.kenliejugarap.com/flux-anime-v2/?prompt=${encodeURIComponent(prompt)}`);
